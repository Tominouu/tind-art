...
const baseProfiles = [
    {
        ...
        ville: "Naples",
        age: "391 ans",
        tag1: "Cosplay de peintres",
        tag2: "Pasta",
        tag3: "Marathonien",
        tag4: "Café",
        image: "../assets/images/card/luca_giordano_card.png",
        infoText: "Je suis tellement rapide pour peindre que mes contemporains me surnomment « Luca Fa Presto », ce qui signifie en italien « Luca, il fait vite »",
        infoImage: "../assets/images/card/description-luca.png",
        matchable: true,
        redflag1: "2 de tension",
        redflag2: "Ponctuel(le)",
        greenflag1: "En avance",
        greenflag2: "Flash Mcqueen"
    },
    {
        id: 2,
        ...
        tag3: "Fêtes",
        tag4: "Amusement",
        image: "../assets/images/card/van_baburen_card.png",
        infoText: "Je suis amoureux des fêtes bien remplies et surtout de la bière. Il me faut quelqu’un pour me raccompagner chez moi. On me surnomme “mouche à bière.”",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: true,
        redflag1: "Bordélique",
        redflag2: "Introverti(e)",
        greenflag1: "Bon délire",
    ...
    },
    {
        ...
        tag2: "Peintures",
        tag3: "Enfants",
        tag4: "Animaux empaillés",
        image: "../assets/images/card/bartolome_esteban_card.png",
        infoText: "J’admire le corps des femmes et j’aime particulièrement les peindre. Je veux des enfants pour les peindre et j’en ai déjà 10.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: true,
        redflag1: "Érotomane",
    ...
    },
    {
        ...
        tag2: "Nuit",
        tag3: "Intimité",
        tag4: "Ombres chinoises",
        image: "../assets/images/card/trophime_bigot_card.png",
        infoText: "J’aime les ambiances intimistes, les soirées à la bougie et les visages qui émergent de l’ombre. On m’a longtemps pris pour quelqu’un d’autre, mais aujourd’hui je sais exactement qui je suis.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: true,
        redflag1: "Narcoleptique",
        redflag2: "Peur du feu",
        greenflag1: "Pyromane",
        greenflag2: "Insomniaque"
    },
    {
        id: 5,
        name: "Pedro de Moya",
        ...
        tag3: "Amour",
        tag4: "Vie",
        image: "../assets/images/card/pedro_de_mayo_card.png",
        infoText: "Si tu veux voyager, que ce soit à l’extérieur ou à l’intérieur, je suis ton âme sœur. Je saurai te faire voyager là où tu découvriras les pépites les plus inattendues.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: true,
        redflag1: "Indécis(e)",
        redflag2: "Sédentaire",
        greenflag1: "Baroudeur(se)",
        greenflag2: "Attentionné(e)"
    },
    {
        id: 6,
        name: "Jean Durand",
        ...
        tag3: "PasDeBuzz",
        tag4: "Old Money",
        image: "../assets/images/card/jean_durand_card.png",
        infoText: "Je n’ai pas de buzz et j’essaie de percer pour vivre de mon art. Je passe plus de temps à rêver de followers qu’à en avoir.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: false,
        redflag1: "0 Buzz",
        redflag2: "Introvertie",
        greenflag1: "Dopamine rapide",
        greenflag2: "Influenceur"
    },
    {
        id: 7,
        name: "Aïssa Koabil",
    ...
    },
    {
        ...
        tag3: "Guitare",
        tag4: "Mode",
        image: "../assets/images/card/mathieu_zylow.png",
        infoText: "Guitare jamais loin, playlist toujours prête. Toujours minutieux sur le choix de mes vestes, mes peinture et le choix de mes accord (et encore plus pour la femme que j’aime). Si t’aimes la musique, et les discussions un peu profondes à 2h du mat, on devrait s’entendre.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: false,
        redflag1: "Envahissant(e)",
        redflag2: "Rap",
        greenflag1: "Créatif",
        greenflag2: "À l’écoute"
    },
    {
        id: 9,
        name: "Dan Antonio",
        ...
        tag3: "Randonnée",
        tag4: "Café",
        image: "../assets/images/card/antonio_card.png",
        infoText: "Mexicain, calme en apparence, intense quand il faut. J’aime les choses simples bien faites : un bon repas, une discussion honnête, et un plan qui ne cherche pas à impressionner. Pas là pour jouer un rôle, juste pour rencontrer quelqu’un de vrai.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: false,
        redflag1: "Têtu(e)",
        redflag2: "Drama",
        greenflag1: "Authenticité",
        greenflag2: "Communication"
    },
    {
        id: 10,
        name: "Vanessa Herbault",
        type: "Coup d'un soir",
        ville: "Cenon",
        age: "26 ans",
        tag1: "Brunchs",
        ...
        tag3: "Esthétique",
        tag4: "Art",
        image: "../assets/images/card/vanessa_card.png",
        infoText: "Je sais ce que je veux et ce que je ne veux pas. J’aime le confort, l’élégance et les hommes qui savent prendre les choses en main. Les relations simples ne m’intéressent pas, je préfère quelqu’un d’ambitieux, généreux et sûr de lui.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: false,
        redflag1: "50/50",
        redflag2: "Simple",
    ...
    },
    {
        ...
        tag3: "Chasse",
        tag4: "Mammouths",
        image: "../assets/images/card/grug_bort_card.png",
        infoText: "J’aime courir après les mammouths le samedi matin avec mes amis. J’aime mon steak bien cuit avec quelques baies des forêts. J’aime courir, sauter, ramper. Toujours à la recherche de nouvelles aventures.",
        infoImage: "../assets/images/card/description-dirck.png",
        matchable: false,
        redflag1: "Végétarien(ne)",
        redflag2: "Méchant(e)",
        greenflag1: "Pyromane",
        greenflag2: "Chasseur(euse)"
    },
    {
        id: 12,
        name: "Chloé Durmont",
        ...
        tag3: "Sculpture",
        tag4: "Asie",
        image: "../assets/images/card/chloe_card.png",
        infoText: "Je suis une artiste, et j’ai besoin d’un ou ... une muse pour inspirer mes créations. Je suis pleine de couleurs et de bonne humeurs. Avec moi tu n’auras jamais le syndrome de la feuille blanche.",
        infoImage: "../assets/images/card/chloe_card.png",
        matchable: false,
        redflag1: "Naïf",
        redflag2: "Molasson",
        greenflag1: "Attentioné(e)",
        greenflag2: "Empathique"
    },
    {
        id: 13,
        name: "Léonie Laval",
